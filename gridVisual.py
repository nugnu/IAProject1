...
def show_grid(problem, node_colors = None):
    ...
    nx.draw_networkx(G, pos=flipped_pos, with_labels=False, node_size = 400*50/(N*M), node_color=node_colors)                                                                       
    plt.axis('off')                       
...
def display_grid_algorithm(algorithm=None, problem=None):
    ...
    def visualize_callback(Visualize):
        if Visualize is True:
            ...
            print("NUMERO DE ITENS INICIAL NO GRID: " + str(problem.numberOfItemsInGrid))
